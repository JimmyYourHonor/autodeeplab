...
class Trainer(object):
    def __init__(self, args):
        ...
        # Define tester network
        self.tester = tester()
        
        optimizer_ex = torch.optim.SGD(
                    self.tester.ex_parameters(),
                    args.lr,
                    momentum=args.weight_decay
            )
        
        optimizer_c = torch.optim.Adam(
                    self.tester.c_parameters(),
                    lr=3e-4,
                    weight_decay=1e-3
            )
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            # Stage 1 optimize weights of learner model 
            ...
            # Stage 2 optimize weights of encoder & executor of tester model
                
            # Stage 3 optimize weights of tester creator and architecture of learner model
